...
| 1 | Deterministic CLI | Current `init`, `adapter validate`, `assess`, `gc`, `loop validate`, `validate`, `migrate`, `run`, `doctor`, `eval`, `trace`, `verify`, and `report`. |
