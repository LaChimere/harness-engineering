---
name: harness-assess
description: Summarize harness maturity and implementation routing from existing evidence. Use when summarizing maturity, gaps, or implementation routing from evidence.
---
---
id: harness-assess
