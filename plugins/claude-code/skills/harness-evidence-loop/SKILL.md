---
name: harness-evidence-loop
description: Sequence explicit Harness evidence commands safely. Use when orchestrating a safe evidence-gathering pass across existing Harness commands.
---
---
